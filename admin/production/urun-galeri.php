          ...
          <div class="x_title">
            ...
            <form action="../baglan/islem.php" method="POST" enctype="multipart/form-data">
              ...
              <div align="right" class="col-md-6">
                <button type="submit" name="urunfotosil" class="btn btn-danger "><i class="fa fa-trash" aria-hidden="true"></i> <?=__c("Seçilenleri Sil")?></button>
                <a class="btn btn-success" href="urun-foto-yukle.php?urun_id=<?php echo $_GET['urun_id']; ?>"><i class="fa fa-plus" aria-hidden="true"></i> <?=__c("Ürün Fotoğraf Yükle")?></a>
              </div>
              <div class="clearfix"></div>
          </div>
            ...
            while ($urunfotocek = $urunfotosor->fetch(PDO::FETCH_ASSOC)) { ?>
              ...
              <div class="col-md-55">
                <label>
                  ...
                  <input type="checkbox" name="urunfotosec[]" value="<?php echo $urunfotocek['urunfoto_id']; ?>"> <?=__c("Seç")?>
                </label>
